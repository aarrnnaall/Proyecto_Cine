    ...
    describe('Pelicula Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/peliculas';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Pelicula', () => {
                service.create(new Pelicula(null)).subscribe(received => {
            ...
            it('should update a Pelicula', () => {
                service.update(new Pelicula(123)).subscribe(received => {
