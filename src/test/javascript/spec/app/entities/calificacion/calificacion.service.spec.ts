    ...
    describe('Calificacion Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a Calificacion', () => {
                service.create(new Calificacion(null)).subscribe(received => {
            ...
            it('should update a Calificacion', () => {
                service.update(new Calificacion(123)).subscribe(received => {
            ...
            it('should return a Calificacion', () => {
            ...
            it('should return a list of Calificacion', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new Calificacion(123)]);
            });
