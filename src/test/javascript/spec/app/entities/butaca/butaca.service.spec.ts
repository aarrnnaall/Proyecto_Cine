    ...
    describe('Butaca Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/butacas';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Butaca', () => {
                service.create(new Butaca(null)).subscribe(received => {
            ...
            it('should update a Butaca', () => {
                service.update(new Butaca(123)).subscribe(received => {
