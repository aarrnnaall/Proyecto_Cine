    ...
    describe('Funcion Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/funcions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Funcion', () => {
                service.create(new Funcion(null)).subscribe(received => {
            ...
            it('should update a Funcion', () => {
                service.update(new Funcion(123)).subscribe(received => {
